...
def filter_t_low_above_t_1_low(results: list[dict]) -> list[dict]:
    ...
    for r in results:
        ...
        t_low_vs_t1_pct  = round((t_low  - t_1_low) / t_1_low * 100, 2)
        price_vs_t1_pct  = round((t_close - t_1_low) / t_1_low * 100, 2)
        ...
        filtered.append({
            **r,
            ...
            't_low':               round(t_low, 2),
            'price_vs_t1_low_pct': price_vs_t1_pct,
            't_low_vs_t1_low_pct': t_low_vs_t1_pct,
        })
